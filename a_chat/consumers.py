...
class ChatroomConsumer(WebsocketConsumer):
    ...
    def online_count_handler(self, event):
        ...
        chat_message = ChatGroup.objects.get(group_name=self.chatroom_name).chat_message.all()[:30]
        author_ids = set([message.author.id for message in chat_message])
...
class OnlineStatusConsumer(WebsocketConsumer):
    ...
    def online_status_handler(self, event):
        ...
        html = render_to_string('a_chat/partials/online_status.html', context)
        self.send(text_data=html)
